var listOfRoles = ['harvester', 'lorry', 'claimer', 'upgrader', 'repairer', 'builder', 'wallRepairer','cleaner'];
...
StructureSpawn.prototype.createCleaner =
    function (energy) {
        ...
        // create creep with the created body and the role 'lorry'
        return this.createCreep(body, undefined, { role: 'cleaner', working: false });
    };
